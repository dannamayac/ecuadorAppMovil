        ...
        <ScrollView style={CashSummaryStyles.container}>
            ...
            <View style={CashSummaryStyles.header}>
                ...
                <View style={CashSummaryStyles.headerInfo}>
                    {[
                        { title: 'Caja actual', value: '$95.00' },
                        { title: 'Recaudo pretendido', value: '$155.00' }
                    ].map((item, index) => (
                        <View key={index} style={CashSummaryStyles.infoItem}>
                            <Text style={CashSummaryStyles.infoText}>{item.title}</Text>
                            <Text style={CashSummaryStyles.infoValue}>{item.value}</Text>
                        </View>
                    ))}
                </View>
            </View>
            ...
            <View style={CashSummaryStyles.row}>
                <TouchableOpacity style={CashSummaryStyles.box} >
                    <Text style={CashSummaryStyles.boxTitle}>Caja inicial</Text>
                    <View style={CashSummaryStyles.boxContent}>
                        <Text style={CashSummaryStyles.boxValue}>00.00 USD</Text>
                        <MaterialCommunityIcons name="chevron-right" size={24} color="black" style={CashSummaryStyles.icon} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={CashSummaryStyles.box} onPress={() => navigation.navigate('WithDrawls')}>
                    <Text style={CashSummaryStyles.boxTitle}>Retiros</Text>
                    <View style={CashSummaryStyles.boxContent}>
            ...
            <View style={CashSummaryStyles.fullWidthBox}>
                <Text style={CashSummaryStyles.collectBoxTitle}>Recaudos efectivo</Text>
